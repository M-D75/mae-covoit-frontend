    ...
    >
        ...
        <div class="row-item btn">
            ...
            >
                ...
                >
                    <v-icon style="height: 22px; line-height: 10; position: relative; top: -3px;"
                            class="zoom-bounce"
                ...
                <div class="btn circle-blc">
                    ...
                    <div class="in-btn" :class="{brand: credit_card.brand=='Visa' || credit_card.brand=='MasterCard'}">
                        <svg v-if="credit_card.brand=='Visa'" class="visa" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 30">
                        ...
                        <svg v-if="credit_card.brand=='MasterCard'" class="mastercard" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 30">
                        ...
                        <v-icon v-if="credit_card.brand!='MasterCard' && credit_card.brand!='Visa'" class="vi-1">mdi-circle</v-icon>
                        <v-icon v-if="credit_card.brand!='MasterCard' && credit_card.brand!='Visa'" class="vi-2">mdi-circle</v-icon>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapState("profil", ["soldes", "gain", "credit_card", "modeDriver", "credit_card"]),
        },
        props: {
            load: {
                type:Boolean,
